    ...
    <div className="min-h-screen bg-slate-50/60 text-slate-900 pb-20">
      ...
      <section className="container mx-auto px-4 sm:px-6 max-w-4xl pt-10 space-y-10">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-white border border-amber-200/70 shadow-xs space-y-4">
          ...
          <div className="p-4 rounded-xl bg-amber-50/60 border border-amber-200 text-xs text-amber-950 leading-relaxed font-medium">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 pt-2">
            ...
            {/* Pillar 1 */}
            <div className="p-6 rounded-2xl bg-white border border-amber-200/70 shadow-xs space-y-3">
              <div className="flex items-center space-x-3">
                <div className="h-8 w-8 rounded-lg bg-amber-50 border border-amber-200 flex items-center justify-center text-amber-800 font-mono font-bold text-xs">
                  01
                </div>
                <div>
            ...
            {/* Pillar 2 */}
            <div className="p-6 rounded-2xl bg-white border border-emerald-200/70 shadow-xs space-y-3">
              <div className="flex items-center space-x-3">
            ...
            {/* Pillar 5 */}
            <div className="p-6 rounded-2xl bg-white border border-purple-200/70 shadow-xs space-y-3">
              <div className="flex items-center space-x-3">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-white border border-amber-200/70 shadow-xs space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
              ...
              <div className="p-2.5 rounded-lg bg-white border border-slate-200 font-mono text-xs text-amber-900 font-semibold">
        ...
        {/* Call to Action */}
        <div className="p-8 rounded-2xl bg-gradient-to-r from-amber-600 via-amber-700 to-amber-800 text-white text-center space-y-4 shadow-md">
          ...
          <div className="pt-2">
            <Link href="/agent">
              <Button className="bg-white hover:bg-amber-50 text-amber-950 font-bold px-6 py-3 rounded-xl shadow-md text-xs transition-all">
